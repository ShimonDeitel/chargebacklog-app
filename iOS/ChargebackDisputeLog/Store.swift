...
final class Store: ObservableObject {
    ...
    private let fileName = "chargebacklog_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Dispute One", detail: "First example entry.", date: now),
            Entry(title: "Sample Dispute Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Dispute Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
